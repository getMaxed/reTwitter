...
<html>
<head>
    <title><?=$profileData->screenName.' (@'.$profileData->username.') edit page';?></title>
    <meta charset="UTF-8" />
        ...
        <div class="profile-nav">
            <div class="profile-navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?=BASE_URL.$user->username.'/following'?>">
                            <div class="n-head">
                                FOLLOWING
                            </div>
                            <div class="n-bottom">
                    ...
                    <li>
                        <a href="<?=BASE_URL.$user->username.'/followers'?>">
                            <div class="n-head">
                                FOLLOWERS
                            </div>
                            <div class="n-bottom">
			...
			<span>
				<button class="f-btn" type="button" onclick="window.location.href='<?=$user->username?>'" value="Cancel">Cancel</button>
			</span>
                    <span>
