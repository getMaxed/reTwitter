$(function () {
    ...
    $(document).on('click', '.people-message', function () {
        ...
        $.post('http://coe.dev/123/projects/xxx/reTwitter/core/ajax/messages.php', {showChatPopup:get_id}, function (data) {
            $('.popupTweet').html(data);
            if (autoscroll) {
                scrolldown();
            }
        ...
        getMessages = function () {
            $.post('http://coe.dev/123/projects/xxx/reTwitter/core/ajax/messages.php', {showChatMessage:get_id}, function (data) {
